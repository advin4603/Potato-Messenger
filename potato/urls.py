...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name="messenger/password_reset_done.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name="messenger/password_reset_confirm.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name="messenger/password_reset_complete.html"
        ),
